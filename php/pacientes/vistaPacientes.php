        ...
        <section>
                ...
                function validar() {
                    ...
                    for (const input of inputs) {
                        if (input.value === "") {
                            ...
                            Swal.fire({title: "Error",text: "El campo " + input.id + " es obligatorio",icon: "error", buttons: ["Aceptar"]});
                            return false;
                        }
                    }
                    return true;
            ...
            <?php
                ...
                if(isset($_REQUEST["btnAgregar"])){
                    ...
                    $pac->setCitas($_REQUEST["citas"]);
                    $pac->setSexo($_REQUEST["sexo"]);
                    $pac->setFchNac($_REQUEST["fch_nac"]);
                    ...
                    ?>
                    </section><section style="position: relative; margin: auto; width: 900px;">
                     <br><br>
                <?php
                    echo $P->filtrar($v1,$v2);
                }else{echo $foot.$P->getTabla()."</section>";  } ?>
    </body>
</html>
