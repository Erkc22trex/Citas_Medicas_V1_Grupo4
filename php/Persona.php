...
//        $sql = "INSERT INTO tblpersona (primerNombre, segundoNombre, primerApellido, segundoApellido, dni, telefono, sexo, fechaDeNacimiento, Edad, direccion, correoElectronico) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
